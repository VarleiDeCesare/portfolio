<template>
	<v-app id="inspire">
		<v-app-bar app :color="`${cor_header}`" flat>
			<v-tabs centered class="ml-n9" color="grey">
				<v-tab :to="{ name: 'Home', params: { cor_letras: cor_letras, }}" :style="`color: ${cor_letras}`">
					Home
				</v-tab>
				<v-tab :to="{ name: 'Portfolio', params: { cor_letras: cor_letras, }}" :style="`color: ${cor_letras}`">
					Portfólio
				</v-tab>
		...
		<v-main class="lighten-3" :style="`background-color: ${cor};`">
			<v-container>
				...
				<!--				<v-row v-if="$route.name === 'Home'">-->
				<!--					<v-col>-->
				<!--						<div class="row">-->
				<!--							<div class="col d-flex justify-content-center link-portfolio">-->
				<!--								<v-btn color="#319795" dark style="background-color: #e59447">-->
				<!--									<router-link to="/portfolio" :style="`color: ${cor_letras};`">Meu Portfolio-->
				<!--										<i class="fas fa-chevron-right fa-sm" style="margin-top: 13px"></i>-->
				<!--									</router-link>-->
				<!--								</v-btn>-->
				<!--							</div>-->
				<!--						</div>-->
